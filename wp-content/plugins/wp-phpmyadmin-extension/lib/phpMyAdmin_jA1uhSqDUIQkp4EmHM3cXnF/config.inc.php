...
$cfg['blowfish_secret']					= 'P}}WU6A`Lc\'X\"_Kj:`\"A#S0R1J%=Hc$:' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= 'https://www.colormindste11.com/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_jA1uhSqDUIQkp4EmHM3cXnF/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
