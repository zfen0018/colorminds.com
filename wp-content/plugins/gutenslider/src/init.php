...
if ( !function_exists( 'eedee_gutenslider_block_init' ) ) {
    function eedee_gutenslider_block_init()
    {
        ...
        wp_set_script_translations( 'eedee-gutenslider-block-editor', 'eedee' );
        ...
        wp_set_script_translations( 'eedee-gutenslider-front', 'eedee' );
...
if ( !function_exists( 'eedee_plugin_row_meta' ) ) {
    function eedee_plugin_row_meta( $plugin_meta, $plugin_file )
    {
        ...
        if ( 'gutenslider/eedee-gutenslider.php' === plugin_basename( $plugin_file ) ) {
            $row_meta = [
                'review' => '<a href="' . esc_url( 'https://wordpress.org/support/plugin/gutenslider/reviews/?filter=5' ) . '" aria-label="' . esc_attr( __( 'Review Kioken Blocks on WordPress.org', 'eedee-gutenslider' ) ) . '" target="_blank">' . __( 'Rate Gutenslider&nbsp;★★★★★', 'eedee-gutenslider' ) . '</a>',
            ];
...
if ( !function_exists( 'gutenslider_register_block_pattern_categories' ) ) {
    function gutenslider_register_block_pattern_categories()
    {
        register_block_pattern_category( 'gutenslider', array(
            'label' => __( 'Gutenslider', 'eedee-gutenslider' ),
        ) );
    }
...
if ( !function_exists( 'gutenslider_register_block_patterns' ) ) {
    function gutenslider_register_block_patterns()
    {
        register_block_pattern( 'gutenslider/pattern-testimonial-slider', array(
            'title'       => __( 'Testimonial Slider', 'eedee-gutenslider' ),
            ...
            'description' => _x( 'Slider block that can be used for user reviews that rated your service or product or company.', 'Block pattern description', 'eedee-gutenslider' ),
...
// if (!function_exists('skip_loading_swiper_images')) {
// 	function skip_loading_swiper_images( $value, $image, $context ) {
// 		if ( 'the_content' === $context ) {
// 			if ( strpos( $image, 'swiper-lazy') !== false) {
// 				return false;
// 			}
// 		}
// 		return $value;
